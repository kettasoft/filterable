...
description: Learn about Filterable's structured exception-handling system, including exception types, handlers, and configuration for strictness and skipping behavior.
tags:
    - exceptions
    - skipping
    - strictness
...
The system is built around three components: **exception types**, **handlers**,
and **configuration**.
