...
class FilteringWithHeaderDrivenModeTest extends TestCase
{
   ...
   */
  public function test_it_filtering_with_enable_global_header_driven_mode_options()
  {
    $engine = 'ruleset';
   ...
   */
  public function test_it_can_filtering_with_allowed_header_driven_mode_engines_only()
  {
    $engine = 'tree';
   ...
   */
  public function test_it_cant_filtering_with_not_allowed_header_driven_mode_engines()
  {
    $engine = 'ruleset';
   ...
   */
  public function test_it_can_filtering_with_engine_map_name_engine()
  {
    $engine = 'mobile';
   ...
   */
  public function test_it_use_default_engine_when_engine_name_not_defined()
  {
    $engine = 'mobile';
   ...
   */
  public function test_it_throw_exception_when_engine_is_not_define()
  {
    $engine = 'mobile';
   ...
   */
  public function test_it_use_engine_with_custom_header_name()
  {
    $engine = 'tree';
   ...
   */
  public function test_it_use_header_driven_mode_per_request_only()
  {
    $engine = 'tree';
