...
/**
 * RLIKE operator (Regular Expression LIKE).
 */
final class RlikeOperator implements OperatorInterface
{
  /**
   * Apply the RLIKE operator to the query builder.
   *
  ...
  {
    return $builder->where($payload->field, 'RLIKE', $payload->asLike('end'));
  }
}
