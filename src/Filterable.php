...
class Filterable implements FilterableContext, Authorizable, Validatable, Commitable
{
    ...
    use Traits\InteractsWithMethodMentoring;
    use Traits\InteractsWithFilterAuthorization;
    use Traits\InteractsWithValidation;
    use Traits\InteractsWithRelationsFiltering;
    use Traits\HasFilterableEvents;
    use Traits\InteractsWithProvidedData;
    use Traits\HasFilterableCache;
    use HandleFluentReturn;
    use Macroable;
     ...
     */
    public function apply(?Builder $builder = null): Invoker|Builder
    {
        try {
     ...
     * @return void
     */
    public static function addSorting(string|array $filterable, callable|string|Invokable $callback, ?Request $request = null): void
    {
     ...
     */
    public function filter(?Builder $builder = null): Invoker|Builder
    {
     ...
     */
    private function initQueryBuilderInstance(?Builder $builder = null)
    {
        if ($builder) {
            return $builder;
        }
     ...
     * @return string
     */
    public function toSql(?Builder $builder = null, $withBindings = false): string
    {
