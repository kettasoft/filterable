import{_ as n,c as a,a as e,o as i}from"./app-C_cxxTRp.js";const l={};function p(t,s){return i(),a("div",null,s[0]||(s[0]=[e(`<h1 id="📦-installation" tabindex="-1"><a class="header-anchor" href="#📦-installation"><span>📦 Installation</span></a></h1><p>To install <strong>Filterable</strong>, simply use Composer to add it to your project:</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">composer</span> require kettasoft/filterable</span>
