...
class Sorter implements Appliable, Sortable
{
     ...
     */
    public function __construct(protected Request $request, ?array $config = null)
    {
     ...
     * @return static
     */
    public static function make(Request $request, ?array $config = null): self
    {
     ...
     * @return $this
     */
    public function setNullsPosition(?string $position = null): self
    {
     ...
     * @return string|null
     */
    public function getNullsPosition(): ?string
    {
