...
class FilterableFacadeTest extends TestCase
{
    ...
    public function test_it_can_create_new_instance()
    {
        $filterable = Filterable::create();
        $this->assertInstanceOf(\Kettasoft\Filterable\Filterable::class, $filterable);
    }

    public function test_it_can_create_instance_with_custom_request()
    {
    ...
    public function test_it_can_set_and_get_model()
    {
    ...
    public function test_it_can_apply_conditional_logic()
    {
        $condition = true;
        $called = false;
    ...
    public function test_it_can_add_and_get_sorting()
    {
    ...
    public function test_it_can_set_and_get_fields_map()
    {
    ...
    public function test_it_can_convert_query_to_sql()
    {
    ...
    public function test_it_can_enable_header_driven_mode()
    {
    ...
    public function test_it_can_disable_sanitizers()
    {
