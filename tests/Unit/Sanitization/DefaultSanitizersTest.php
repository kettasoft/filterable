...
class DefaultSanitizersTest extends TestCase
{
  // ─────────────────────────────────────────────
  // TrimSanitizer
  // ─────────────────────────────────────────────
  ...
  {
    $this->assertSame('hello', HandlerFactory::handle('  hello  ', 'trim'));
  }
  ...
  {
    $this->assertSame('hello', HandlerFactory::handle('HELLO', 'lowercase'));
  }
  ...
  {
    $this->assertSame('HELLO', HandlerFactory::handle('hello', 'uppercase'));
  }
  ...
  {
    $this->assertSame('Hello', HandlerFactory::handle('<b>Hello</b>', 'strip_tags'));
  }
  ...
  {
    $this->assertSame('&lt;b&gt;', HandlerFactory::handle('<b>', 'escape_html'));
  }
  ...
  {
    $this->assertSame(7, HandlerFactory::handle('7', 'integer'));
  }
  ...
  {
    $this->assertSame(1.5, HandlerFactory::handle('1.5', 'float'));
  }
  ...
  {
    $this->assertTrue(HandlerFactory::handle('yes', 'boolean'));
    $this->assertFalse(HandlerFactory::handle('no', 'boolean'));
  }
  ...
  {
    $this->assertSame('hello-world', HandlerFactory::handle('Hello World', 'slug'));
  }
  ...
  {
    $this->assertNull(HandlerFactory::handle('', 'null_if_empty'));
  }
  ...
  public function test_clamp_alias_resolves_via_handler_factory()
  {
    ...
    $this->assertSame(200, HandlerFactory::handle(200, 'clamp'));
  }
  ...
  {
    $this->assertSame('hello', HandlerFactory::handle('hello!', 'strip_chars'));
  }

  // ─────────────────────────────────────────────
  // HandlerFactory::aliases() & extend()
  // ─────────────────────────────────────────────

  public function test_handler_factory_returns_all_built_in_aliases()
  {
    $aliases = HandlerFactory::aliases();
  ...
  {
    HandlerFactory::extend(['my_trim' => TrimSanitizer::class]);

    $this->assertArrayHasKey('my_trim', HandlerFactory::aliases());
    $this->assertSame('hello', HandlerFactory::handle('  hello  ', 'my_trim'));
  }
}
